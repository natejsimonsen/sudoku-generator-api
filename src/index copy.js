...
const solveBlockRowsAndColumns = (blockIndexes) => {
  ...
  for (let j = 0; j < blockIndexes.length; j++) {
    ...
    // after this the block should be either valid or invalid
    // if it is valid don't do anything
    // if it is invalid that means we need to move to the previous block, find a different solution and check if the solution is valid
    console.log(block);
    console.log(block.flat());
...
console.log();
console.log(solveBlockRowsAndColumns([1, 2, 3, 5, 6, 7]));

// sudokuGrid.forEach((block, i) => {
//   if (i !== 0) console.log();
//   block.forEach((row) => console.log(row));
// });
